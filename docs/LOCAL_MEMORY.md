...
applied after a local backup, preserving all existing history. Persistent queueing
is now implemented; network delivery is still pending. See `SYNC_CONTRACT.md`.
Full suite: 168 passing tests.

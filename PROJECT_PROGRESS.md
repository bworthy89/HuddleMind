...
both legacy v1 players and the additive ratings member, validating names, ranges
and duplicates. Web player details group ratings and distinguish missing values
from zero. Current Tulane save read-only verification found 56 fields for each of
